...
description: Review scope, blocked operations, confirmations, partial failure, and recovery for Octoform 0.3.1.
---
...
Octoform `0.3.1` has no generic rollback command. Declare the previous value
