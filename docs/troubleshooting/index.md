...
description: Diagnose configuration, authentication, capability, planning, and apply failures in Octoform 0.4.
---
...
| Environment reviewers blocked | Existing team reviewer cannot be represented by `0.4` | Preserve the remote setting or manage it outside this version |
